export function Cards() {
  return (
    <>
      <div className="w-full bg-black mt-40 py-10">
        <div className="flex px-20 ">
          <div className="flex justify-between w-full">
            <div className=" w-[24rem]  bg-neutral-800/35 rounded-3xl ">
              <div className="relative h-[22rem] [mask:linear-gradient(transparent,black,transparent)]">
                <svg
                  className="z-20 "
                  fill="none"
                ...
                <div
                  className="h-[20rem] w-[16rem] bg-neutral-800/35 flex absolute right-4
                                    top-4
            ...
            <div className=" w-[24rem] bg-neutral-800/35 rounded-3xl flex flex-col">
              <div className="relative flex h-[22rem] [mask:linear-gradient(transparent,black,transparent)]">
                ...
                <img
                  src="/mobile-app.svg"
                  className="w-[9rem] z-10 absolute right-32 bottom-4 "
                />
                <img
                  src="/hand.png"
                  className="absolute z-20 w-40 bottom-[1rem] left-[13rem]"
                />
              </div>
              <div className="px-5 pt-4">
                ...
                <p className="text-[14px] text-neutral-500 py-4">
                  ...
                  our iOS/Android mobile apps. Because, you know, it’s 2025.
                </p>
              </div>
            </div>
            <div className=" w-[24rem] bg-neutral-800/35  rounded-3xl">
              <div className="px-5 pt-8">
                <div class="mb-4 w-full h-[20rem] overflow-hidden [mask:linear-gradient(transparent,black,transparent)]">
                  <ul role="list" className="space-y-4 pt-2 pr-4 pl-2">
                    <li class="relative flex gap-x-2">
                      <div class="-top-10 -bottom-6 left-0 absolute flex justify-center w-6">
                        <div class="bg-zinc-800 w-px"></div>
                      </div>
                      <div class="relative flex flex-none justify-center items-center w-6 h-6">
                        <div class="bg-zinc-950 rounded-full ring-1 ring-zinc-800 w-2 h-2"></div>
                      </div>
                      <div class="flex-auto bg-zinc-900 p-3 rounded-md ring-1 ring-zinc-400/10 ring-inset select-none">
                        <div class="flex items-center gap-2">
                          <div class="flex justify-center items-center bg-zinc-950 rounded-full ring-1 ring-zinc-400/10 w-5 h-5">
                            <svg
                              class="w-2.5 h-2.5"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 10 10"
                        ...
                        <div class="ml-7">
                          ...
                          <div class="flex gap-2.5 mt-2">
                            <button class="flex justify-center items-center bg-zinc-700 hover:bg-zinc-800 px-1.5 py-0.5 rounded text-xs text-zinc-300 transition">
                              Approve
                            </button>
                            <button class="flex justify-center items-center bg-zinc-700 hover:bg-zinc-800 px-1.5 py-0.5 rounded text-xs text-zinc-300 transition">
                              Decline
                    ...
                    <li class="relative flex gap-x-2">
                      <div class="top-0 -bottom-6 left-0 absolute flex justify-center w-6">
                        <div class="bg-zinc-800 w-px"></div>
                      </div>
                      <div class="relative flex flex-none justify-center items-center w-6 h-6">
                        <div class="bg-zinc-950 rounded-full ring-1 ring-zinc-800 w-2 h-2"></div>
        ...
        <div className="flex px-20">
          <div className="flex pt-10 w-full justify-around">
            <div className="h-[30rem] w-[44rem]  bg-neutral-800/35 rounded-3xl relative">
              <div class="[mask:radial-gradient(60%_60%_at_50%,rgba(0,0,0,0.9)_35%,rgba(0,0,0,0)_100%)]">
                <div class="flex justify-between transform-gpu">
                  <div class="flex flex-col gap-8 -ml-4 sm:ml-8">
                    <div class="flex justify-center items-center bg-zinc-950 hover:opacity-95 rounded-full ring-1 ring-zinc-100/10 w-16 h-16 transition-all duration-200 hover:scale-110 hover:cursor-pointer">
                      <svg
                        class="w-8 h-8"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 32 32"
                  ...
                  <div class="flex flex-col gap-8 pt-8">
                    ...
                    <div class="flex justify-center items-center bg-zinc-950 hover:opacity-95 rounded-full ring-1 ring-zinc-100/10 w-16 h-16 transition-all duration-200 hover:scale-110 hover:cursor-pointer">
                      ...
                      >
                        <path
                          d="M35.63.4H.45v29.46h35.18V.41Z"
                          fill="#fff"
                        ></path>
                        <path
                  ...
                  <div class="flex flex-col gap-8 -mr-4 sm:mr-8">
                    <div class="flex justify-center items-center bg-zinc-950 hover:opacity-95 rounded-full ring-1 ring-zinc-100/10 w-16 h-16 transition-all duration-200 hover:scale-110 hover:cursor-pointer">
                      <svg
                        class="w-10"
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="h-[30rem] w-[28rem] bg-neutral-800/35 rounded-3xl overflow-hidden ">
              <div className="px-5 pt-8">
               <div
               className="h-[16rem]"
               >
                 <div className="relative">
                  <div className="top-4 -left-1 absolute w-[891px] h-[243px]">
                    <img className="absolute z-10" src="keyboard.png" />
                    <img className="absolute z-20" src="keyboardBlue.png" />
                    <div className=" w-[18rem] bg-neutral-800/35 flex absolute left-10 -top-8
                                    backdrop-blur-md rounded-xl absolute z-40">
                      <div
                      className="flex-1"
                      >
                        <svg
                        ...
                        >
                          <g
                            ...
                            stroke-linejoin="round"
                          >
                            <path d="M26 220.67a6.67 6.67 0 1 0 0-13.34 6.67 6.67 0 0 0 0 13.34Zm-4.71-11.38 2.82 2.82m3.78 0 2.82-2.82m-2.82 6.6 2.82 2.82m-6.6-2.82-2.82 2.82"></path>
                            <path d="M26 216.67a2.67 2.67 0 1 0 0-5.34 2.67 2.67 0 0 0 0 5.34Z"></path>
                          </g>
                          <path
                          ...
                          <g
                            ...
                            stroke-linejoin="round"
                          >
                            <path d="M26 138.67a6.67 6.67 0 1 0 0-13.34 6.67 6.67 0 0 0 0 13.34Z"></path>
                            <path d="M28.67 129.33h-4a1.33 1.33 0 0 0 0 2.67h2.66a1.33 1.33 0 0 1 .95 2.28c-.25.25-.6.39-.95.39h-4M26 136v-8"></path>
                          </g>
                          <rect
                            x="10"
                            y="91"
