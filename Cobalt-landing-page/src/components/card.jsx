      ...
      <div className="w-full bg-black mt-40 py-10">
        ...
        <div className="flex px-20">
          <div className="flex pt-10 w-full justify-around">
            ...
            <div className="h-[30rem] w-[28rem] bg-neutral-800/35 rounded-3xl ">
              <div className="px-5 pt-8">
                <div className="relative">
                  <div className="top-0 -left-16 sm:-left-12 lg:left-8 absolute w-[891px] h-[243px]">
                    <img className="absolute z-10" src="keyboard.png" />
                    <img className="absolute z-20" src="keyboardBlue.png" />
                    <div className="w-[30rem] absolute z-40">
                      <svg
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 314 234"
