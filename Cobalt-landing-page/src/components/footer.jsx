  ...
  return (
    <>
      <div className="mb-10 w-full">
        <div className="flex w-full flex-col gap-4 px-4 sm:px-8 md:px-12 lg:px-24 xl:px-40">
          ...
          <div className="flex-1">
            <div className="flex flex-col-reverse items-center justify-between gap-3 text-[1rem] text-neutral-400 md:flex-row">
              <div className="flex flex-col-reverse items-center gap-2 md:flex-row md:items-baseline md:gap-4">
            ...
            <div className="flex flex-col text-center text-[0.8rem] text-neutral-600 md:w-[22rem] md:text-left">
              <span>
                Cobalt is a trademark or registered trademark of Cobalt
                Financial Technologies Inc. Any other trademarks are the
                property of their respective owners. Unless otherwise noted, use
                of third party logos does not imply endorsement of, sponsorship
                of, or affiliation with Cobalt.
              </span>
              <span>
