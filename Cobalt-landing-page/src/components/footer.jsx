export function Footer() {
  return (
    <>
      <div className="mb-10 w-full px-20">
        <div className="flex flex-col gap-4">
          <div className="h-px w-full bg-blue-400"></div>
          <div className="flex justify-between gap-3 text-[1rem] text-neutral-400">
          ...
          <div className="flex w-[45rem] flex-col text-[0.8rem] text-neutral-600">
            <span>
