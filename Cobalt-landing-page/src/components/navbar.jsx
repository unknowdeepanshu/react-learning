export function Navbar() {
  return (
    <>
      <div className="relative top-[1.4rem] flex w-full items-center justify-between px-[3rem]">
        <svg
          fill="none"
        ...
        <div className="flex items-center gap-6">
          <a
            className="text-[0.9rem] text-neutral-300 transition-colors hover:text-neutral-50"
            href="#"
          >
            <b>Blog</b>
          </a>
          <button className="relative cursor-pointer overflow-hidden rounded-4xl border-[1px] border-neutral-700 bg-black px-4 py-2 text-[0.8rem] text-neutral-400 hover:text-white hover:shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)]">
