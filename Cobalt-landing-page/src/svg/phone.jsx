export function Phone() {
  return (
    <>
      <div className="relative flex h-[22rem] [mask:linear-gradient(transparent,black,transparent)]">
        <svg
          fill="none"
          className="z-0"
        ...
        <div className="absolute inset-x-0 z-10 mx-auto flex w-full justify-center">
          <img src="/mobile-app.svg" className="w-[9rem]" />
          <img
            src="/hand.png"
            className="absolute top-40 left-[11rem] z-20 w-40"
          />
        </div>
      </div>
    </>
